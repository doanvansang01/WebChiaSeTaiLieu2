...
$id = $_SESSION['id'];
if ($id != '' && $id > 0) {
    $connect = mysqli_connect("sql210.epizy.com", "epiz_33123295", "hfXtdfiDvG", "epiz_33123295_library") or die("Connect faild");
...
<body>
    ...
    <div id="wrapper" style="margin: 100 0 0 0;">
        ...
        <div>
            <p>
            <h4 style="margin-left: 300px"> Thông tin của bạn</h4>
            </p>
        </div>
        <div class="panel-body table-responsive" style="margin-left: 300px">
            ...
            <form method="post" enctype="multipart/form-data" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                ...
                <div class="form-group" style="width:50%">
                    ...
                    <input required="true" class="form-control" type="text" name="downloads" value="<?php echo $downloads; ?>" disabled>
                </div>
        </div>
